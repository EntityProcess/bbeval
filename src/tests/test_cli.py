#!/usr/bin/env python3
"""
Unit tests for eval_runner.cli module.
...
from eval_runner.models import AgentTimeoutError
from eval_runner.cli import _run_test_case_with_retries
...
class TestRunTestCaseWithRetries(unittest.TestCase):
    ...
    @patch('eval_runner.cli.focus_vscode_workspace')
    @patch('eval_runner.cli.build_prompt_inputs')
    @patch('eval_runner.cli.evaluate_test_case')
    @patch('eval_runner.cli.write_result_line')
