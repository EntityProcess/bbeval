...
class QualityGrader(dspy.Signature):
    ...
    reasoning = dspy.OutputField(desc="A brief explanation for the score, focusing on how well the generated_answer achieved all the criteria defined in the expected_outcome.")
